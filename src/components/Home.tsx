	...
	return (
		<div className="h-dvh justify-center">
			<button
				type="button"
				onClick={openModal}
				className="flex justify-center items-center w-[184px] h-16 mt-40 bg-[#FF5F00] hover:bg-[#FF9E59] border-transparent rounded-2xl px-2 py-4 text-white"
			>
				{t('Filter')}
			</button>
			{filters && filters.length > 0 && (
				<div className="mt-14 justify-center">
					<h2>{t('Your results')}</h2>
